      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Disponibilité des fonds</h2>
            <p className="text-xl text-gray-600">
              Gérez et contrôlez vos propres fonds chez le broker LegoMarket LCC
              en utilisant l'application MetaTrader 4 ou avec le broker de votre
              choix en téléchargeant le robot sur le site Pansaka.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Aucun logiciel à installer. Nulle compétence en trading requise.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Solution de trading développée par Pansaka, axée sur le marché
                de l'or.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Plus de 2 années en condition réelle du marché.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Commencez l'expérience avec un capital minimum de 250 $.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Résultats transparents sur votre application MetaTrader 4.
              </p>
            </div>
          </div>
        </div>
